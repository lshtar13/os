...
binutilsName="binutils-2.41"
gccName="gcc-11.4.0"
downloads=(
  "$binutilsName https://ftp.gnu.org/gnu/binutils/binutils-2.41.tar.gz"
  "$gccName https://ftp.gnu.org/gnu/gcc/gcc-11.4.0/gcc-11.4.0.tar.gz"
)
